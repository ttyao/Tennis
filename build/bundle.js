...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MatchRecorder = __webpack_require__(160);

	var _MatchRecorder2 = _interopRequireDefault(_MatchRecorder);

	var _FirebaseModule = __webpack_require__(170);
	...
	function main() {
	  _reactDom2.default.render(_react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(_FirebaseModule2.default, null),
	    _react2.default.createElement(_MatchRecorder2.default, null)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PlayerSelect = __webpack_require__(161);

	var _PlayerSelect2 = _interopRequireDefault(_PlayerSelect);

	var _ScoreSelect = __webpack_require__(168);

	var _ScoreSelect2 = _interopRequireDefault(_ScoreSelect);

	var _Notice = __webpack_require__(169);
	...
	var MatchRecorder = function (_React$Component) {
	  _inherits(MatchRecorder, _React$Component);

	  function MatchRecorder(props) {
	    _classCallCheck(this, MatchRecorder);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MatchRecorder).call(this, props));

	    _this.state = { players: {}, scores: {}, message: "" };
	    _this.handlePlayerChange = _this.handlePlayerChange.bind(_this);
	    _this.handleScoreChange = _this.handleScoreChange.bind(_this);
	    _this.handleMatchSubmit = _this.handleMatchSubmit.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(MatchRecorder, [{
	    ...
	    key: 'handleMatchSubmit',
	    value: function handleMatchSubmit() {

	      if (!this.state.players.player1 || !this.state.players.player2 || this.state.players.player1.split(',').length != this.state.players.player2.split(',').length) {
	        return;
	      }
	    ...
	    value: function handlePlayerChange(id, value) {
	      // this is silly...
	      var newState = this.state;
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_Notice2.default, { notice: this.state.message }),
	        _react2.default.createElement(_PlayerSelect2.default, { label: 'players', onChange: this.handlePlayerChange }),
	        _react2.default.createElement(
	          'div',
	          null,
	          'Score:'
	        ),
	        _react2.default.createElement(_ScoreSelect2.default, { id: 'set1', onChange: this.handleScoreChange }),
	        _react2.default.createElement(_ScoreSelect2.default, { id: 'set2', onChange: this.handleScoreChange }),
	        _react2.default.createElement(_ScoreSelect2.default, { id: 'set3', onChange: this.handleScoreChange }),
	        _react2.default.createElement(
	          'button',
	          { onClick: this.handleMatchSubmit },
	          'Submit Score'
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlayerSelect = _react2.default.createClass({
		...
		handleSelectChange1: function handleSelectChange1(value, values) {
			this.setState({ player1: value });
			this.props.onChange("player1", value);
		},
		handleSelectChange2: function handleSelectChange2(value, values) {
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'span',
								{ className: 'section' },
								_react2.default.createElement(_reactSelect2.default, { multi: true, value: this.state.player1, placeholder: 'Select player(s)', onChange: this.handleSelectChange1, asyncOptions: this.loadOptions })
							)
						)
					),
					_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'span',
								{ className: 'section' },
								_react2.default.createElement(_reactSelect2.default, { multi: true, value: this.state.player2, placeholder: 'Select player(s)', asyncOptions: this.loadOptions, onChange: this.handleSelectChange2 })
							)
						)
					)
				)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScoreSelect = function (_React$Component) {
	  _inherits(ScoreSelect, _React$Component);

	  function ScoreSelect(props) {
	    _classCallCheck(this, ScoreSelect);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ScoreSelect).call(this, props));

	    _this.state = { score1: 0, score2: 0 };
	    _this.handleScore1Change = _this.handleScore1Change.bind(_this);
	    _this.handleScore2Change = _this.handleScore2Change.bind(_this);
	    return _this;
	  }

	  _createClass(ScoreSelect, [{
	    key: 'getOtherScore',
	    value: function getOtherScore(value) {
	      switch (value) {
	        case 6:
	          return -1;
	        case 7:
	    ...
	    key: 'handleScore1Change',
	    value: function handleScore1Change(value) {
	    ...
	    key: 'handleScore2Change',
	    value: function handleScore2Change(value) {
	      var otherScore = this.getOtherScore(value);
	      if (otherScore > 0) {
	    ...
	    key: 'render',
	    value: function render() {
	      var options = [{ value: 0, label: '0' }, { value: 1, label: '1' }, { value: 2, label: '2' }, { value: 3, label: '3' }, { value: 4, label: '4' }, { value: 5, label: '5' }, { value: 6, label: '6' }, { value: 7, label: '7' }];
	      return _react2.default.createElement(
	        'table',
	        { className: 'wholerow' },
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(_reactSelect2.default, { options: options, value: this.state.score1, onChange: this.handleScore1Change })
	            ),
	            _react2.default.createElement(
	              'td',
	              { className: 'divider' },
	            ...
	            _react2.default.createElement(
	              'td',
	              { className: 'scoresection' },
	              _react2.default.createElement(_reactSelect2.default, { options: options, value: this.state.score2, onChange: this.handleScore2Change })
	            ),
	            _react2.default.createElement('td', { className: 'rowlabel' })
	          )
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Notice = function (_React$Component) {
	  ...
	  function Notice(props) {
	    ...
	    _this.state = { message: props.notice };
	    return _this;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FirebaseModule = function (_React$Component) {
	  _inherits(FirebaseModule, _React$Component);

	  function FirebaseModule(props) {
	    _classCallCheck(this, FirebaseModule);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(FirebaseModule).call(this, props));

	    _this.state = { authData: null };
	    return _this;
	  }
	  ...
	  _createClass(FirebaseModule, [{
	    ...
	    value: function authDataCallback(authData) {
	      if (!authData) {
	        var ref = new _firebase2.default("https://blistering-torch-8342.firebaseio.com");
